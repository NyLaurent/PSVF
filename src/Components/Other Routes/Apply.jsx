  ...
  return (
    <div>
      ...
      <div className='flex justify-center flex-col text-center relative'>
        <h1 className='text-[#325AAB] text-2xl font-extrabold mb-5'>Application Information</h1>
        <h3 className='text-black font-bold'>Please fill out the application form below to apply for admission.</h3>
        <p className='text-1xl'>We are excited to review your application and look forward to welcoming you to our community.<br /> If you have any questions, feel free to reach out.</p>
      </div><br />
          ...
          {[1, 2, 3].map((num) => (
            <div key={num} className='text-center md:text-left mb-4 md:mb-0'>
              ...
              <ul className='flex flex-col cursor-pointer'>
                <li>Email: info@saintleon.edu</li>
                <li>Phone: +123 456 7890</li>
                <li>Address: 123 Saint Leon St, Kigali</li>
              </ul>
            </div>
          ))}
        </div>
