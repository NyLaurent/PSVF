...
const handleDragOver = (e) => {
  e.preventDefault();
  e.stopPropagation();
  // Add visual feedback or styles if needed
};
      ...
      <form>
        <div className='flex flex-col md:flex-row justify-center gap-12 mb-4'>
          <div className="flex flex-col">
            ...
            <input type="text" id="firstName" className="mt-1 p-2 border border-gray-300 rounded w-full md:w-[400px]" placeholder="Enter your First name" />
          </div>
          <div className="flex flex-col">
            <label htmlFor="lastName" className="mb-1 font-extrabold text-[#325AAB]">Last Name</label>
            <input type="text" id="lastName" className="mt-1 p-2 border border-gray-300 rounded w-full md:w-[400px]" placeholder="Enter your Last name" />
          </div>
        </div>
        ...
        <div className='flex flex-col md:flex-row justify-center gap-12 mb-4'>
          <div className="flex flex-col">
            ...
            <input type="text" id="sector" className="mt-1 p-2 border border-gray-300 rounded w-full md:w-[400px]" placeholder="Enter your Sector" />
          </div>
          <div className="flex flex-col">
            <label htmlFor="cell" className="mb-1 font-extrabold text-[#325AAB]">Cell</label>
            <input type="text" id="cell" className="mt-1 p-2 border border-gray-300 rounded w-full md:w-[400px]" placeholder="Enter your Cell" />
          </div>
        </div>
        ...
        <div className='flex flex-col md:flex-row justify-center gap-12 mb-4'>
          <div className="flex flex-col">
            <label htmlFor="dragDropArea1" className="mb-1 font-extrabold text-[#325AAB]">Applicant P6 result slip</label>
            <textarea
              ref={textareaRef1}
              id="dragDropArea1"
              className="mt-1 p-2 border border-gray-300 rounded w-full md:w-[400px] h-[200px]"
              rows="4"
          ...
          <div className="flex flex-col">
            <label htmlFor="dragDropArea2" className="mb-1 font-extrabold text-[#325AAB]">Baptism card</label>
            <textarea
              ref={textareaRef2}
              id="dragDropArea2"
              className="mt-1 p-2 border border-gray-300 rounded w-full md:w-[400px] h-[200px]"
        ...
        <div className='flex justify-center'>
          <button type="submit" className="px-4 py-2 w-[850px] bg-[#325AAB] text-white rounded mt-4">
            Submit
          </button>
        </div>
      </form><br /><br />
